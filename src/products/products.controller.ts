...
export class ProductsController {
  ...
  @ApiBearerAuth()
  @Get('/list')
  public getAllSpecificFieldsProducts(
  ...
  public getAllProductsByPagination(
  ...
  public getProductsByCategory(
    ...
    console.log('MY');
    return this.productService.getProductsBySubCategory(categoryId, query);
  }
  @Get('byBrand/:id')
  findBrand(@Param('id') id: string) {
    return this.productService.findBrand(id);
  }
  // sends request to get products by category
  ...
  public updateProduct(
    ...
    @Param('productId') productId: string,
    @Body() productData: ProductsDTO,
    @Body() productstockData: ProdStockDTO,
  ): Promise<CommonResponseModel> {
    return this.productService.updateProductRecord(
      user,
      productId,
      productData,
      productstockData,
  ...
  public updateProductStock(
    ...
    return this.productService.stockUpdateOne(
      user,
      productId,
      productstockData,
    );
  ...
  public updateStatus(
    @Param('productId') productId: string,
    @Body() statuData: PuductStatusDTO,
  ): Promise<CommonResponseModel> {
  ...
  @Get('/filter/:query')
  public getFilterProductList(
    @Param('query') search_key: string,
    @Query() query,
  ): Promise<CommonResponseModel> {
